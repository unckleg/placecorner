...
$(document).ready(function($) {
    ...
    if( customizerEnabled == 1 ){
        $.getScript( "/skins/frontend/assets/misc/customizer.js", function( data, textStatus, jqxhr ) {
...
// Render hero search form ---------------------------------------------------------------------------------------------
    ...
    $("select").on("rendered.bs.select", function () {
        $('head').append( $('<link rel="stylesheet" type="text/css">').attr('href', '/skins/frontend/assets/css/bootstrap-select.min.css') );
        if( !viewport.is('xs') ){
...
function socialShare(){
    ...
    if ( socialButtonsEnabled == 1 ){
        $('head').append( $('<link rel="stylesheet" type="text/css">').attr('href', '/skins/frontend/assets/css/jssocials.css') );
        $('head').append( $('<link rel="stylesheet" type="text/css">').attr('href', '/skins/frontend/assets/css/jssocials-theme-minima.css') );
        $.getScript( "/skins/frontend/assets/js/jssocials.min.js", function( data, textStatus, jqxhr ) {
...
function initializeReadMore(){
    ...
    $.ajax({
        type: "GET",
        url: "/skins/frontend/assets/js/readmore.min.js",
