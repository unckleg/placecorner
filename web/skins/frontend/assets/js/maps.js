...
function heroMap(_latitude,_longitude, element, markerTarget, sidebarResultTarget, showMarkerLabels, mapDefaultZoom){
    if( document.getElementById(element) != null ){
        ...
        map = new google.maps.Map(document.getElementById(element), {
            ...
            mapTypeId: "roadmap",
            styles: [
                { "featureType": "poi","elementType": "all","stylers": [{"visibility": "off"},{"hue": "#ffffff"},{"saturation": -100},{"lightness": 100}] }
            ]
        });
        ...
        var allMarkers,
            places = $.getJSON('sidebar'),
            markerClusters = new MarkerClusterer(map, null, {
        ...
        function placeMarkers(markers){
            ...
            for (i = 0; i < Object.keys(markers).length; i++) {
                ...
                if( markers[i]["image"] != undefined ){
                    ...
                    thumbnailImage = "/skins/frontend/assets/img/items/default.png";
                }
        ...
        */
        ...
        function loadData(url, ajaxData){
            console.log(url);
            $.ajax({
                url: 'http://place-corner.local/app_dev.php/search',
                dataType: "json",
                method: "POST",
                data: ajaxData,
                cache: false,
